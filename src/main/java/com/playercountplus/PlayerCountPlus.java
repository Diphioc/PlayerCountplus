package com.customplayercount;

import com.playercountplus.Commands.CPCCommand;
import com.playercountplus.Listeners.Ping;
...
public class PlayerCount+ extends JavaPlugin {
    ...
    public static String Prefix = "[PlayerCount+] ";
    ...
    private void registerCommands(ConsoleCommandSender console) {
        getCommand("pc").setExecutor(new PC+Command());
